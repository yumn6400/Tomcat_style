...
pw.println("<input type='hidden' id='employeeId' name='employeeId' value='"+employee.getEmployeeId()+"'>");
pw.println("<table>");
pw.println("<tr>");
pw.println("<td>Name</td>");
pw.println("<td><input type='text' id='name' name='name' value='"+employee.getName()+"' maxlength='35' size='36'>");
...
if(code==employee.getDesignationCode())
{
...
pw.println("<td>");
pw.println("<input type='text' id='basicSalary' name='basicSalary' value='"+employee.getBasicSalary().toPlainString()+"'>");
pw.println("<span id='basicSalaryErrorSection' style='color:red'></span><br>");
pw.println("</td>");
pw.println("<tr>");
pw.println("<td>PAN Number </td>");
pw.println("<td>");
pw.println("<input type='text' id='panNumber' name='panNumber' value='"+employee.getPANNumber()+"'>");
...
pw.println("<td>");
pw.println("<input type='text' id='aadharCardNumber' name='aadharCardNumber' value='"+employee.getAadharCardNumber()+"'>");
...
pw.println("<form id='cancelUpdationForm' action='/styleone/designationsView'>");
pw.println("</form> ");
pw.println("</body>");
pw.println("</html>");
