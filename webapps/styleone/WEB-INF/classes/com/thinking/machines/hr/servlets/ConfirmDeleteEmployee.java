...
pw.println("Date of birth :<b>"+simpleDateFormat.format(employeeDTO.getDateOfBirth())+"</b><br>");
if(employeeDTO.getGender().equals("M"))
{
pw.println("Gender :<b>Male</b><br>");
}
else
{
pw.println("Gender :<b>Female</b><br>");
}
if(employeeDTO.getIsIndian()==true)
{
pw.println("Is Indian  :<b>Yes</b><br>");
}
else
{
pw.println("Is Indian  :<b>No</b><br>");
}
pw.println("Basic salary:<b>"+employeeDTO.getBasicSalary()+"</b><br>");
pw.println("PAN number :<b>"+employeeDTO.getPANNumber()+"</b><br>");
pw.println("Aadhar card number :<b>"+employeeDTO.getAadharCardNumber()+"</b><br><br>");
