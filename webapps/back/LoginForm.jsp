...
<div style='margin-top:9px;margin-botton:9px;font-size:28pt'>Thinking Machines</div>
...
<form method='post' style='margin-left:380px;margin-right:380px;border:1px solid black;padding:20px;' action='/stylethree/Login.jsp' onsubmit='return validateForm(this)'>
